...
#[test]
fn negative_small_parse_scientific_notation_from_string() {
    let input = "-5x10^-15";
...
#[test]
fn negative_small_parse_scientific_notation_from_string_2() {
...
#[test]
fn negative_small_parse_with_error_invalid_exponent() {
    let input = "-2x10^-23.4";
...
#[test]
fn negative_small_parse_with_error_invalid_coefficient() {
    let input = "-2ax10^-20";
    let sci_notation = ScientificNotation::parse_from_str(input);
...
#[test]
fn negative_small_parse_with_error_x10_repeated() {
...
#[test]
fn negative_small_parse_with_error_invalid_input() {
    let input = "asd1234";
    let sci_notation = ScientificNotation::parse_from_str(input);
...
#[test]
fn negative_small_parse_and_display_back() {
...
#[test]
fn negative_small_parse_i64_max_mantissa() {
...
#[test]
fn negative_small_parse_i64_min_mantissa() {
    let input = "-9.223372036854775807x10^-5";
    let sci_notation = ScientificNotation::parse_from_str(input);
...
#[test]
fn negative_small_parse_max_exponent(){
